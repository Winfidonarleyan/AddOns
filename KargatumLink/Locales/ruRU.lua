...
function Return_ruRU()
  return {
    ...
    ["tt_WhispOnButton"] = "Принимать сообщения от игроков.",
    ["tt_WhispOffButton"] = "Не принимать сообщения от игроков.",
    ["tt_InvisOnButton"] = "Стать невидимым.",
    ["tt_InvisOffButton"] = "Стать видимым.",
    ...
    ["ma_IconHint"] = "|cffeda55fЖми|r чтобы открыть KargatumАдмин. |cffeda55fШифт+Клик|r чтобы перезагрузить интерфейс. |cffeda55fАлт+Клик|r сбросить счётчик тикетов.",
    ...
    ["tt_DisplayAccountLevel"] = "Показать уровень чара",
    ["tt_TicketOn"] = "Сообщать о новых тикетах.",
    ["tt_TicketOff"] = "Не сообщать о новых тикетах.",
    ["info_revision"] = "|cFF00FF00Версия ядра:|r ",
    ...
    --[[Linkifier]]
    ["lfer_Error"] = "Ошибка какая-то... Error Search String Matched but an error occured or unable to find type",
	["lfer_Spawn"] = "+",
    ["lfer_List"] = "Лист",
    ["lfer_Goto"] = "К Выбранному",
	...
	["lfer_AddNpc"] = "В Нпц",
	["lfer_Log"] = "Логнуть",
	["lfer_Complete"] = "Завершить",
	["lfer_+Aura"] = "+Аура",
	["lfer_-Aura"] = "-Аура",
    ["lfer_KargatumTiOpen"] = "Открыть",
	["lfer_Kargatumtest"] = "Жмяк"
  }
end
