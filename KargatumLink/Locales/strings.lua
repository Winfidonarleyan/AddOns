...
function ReturnStrings_ruRU()
  return {
    ...
    ["lfer_NPCInfoentry1"] = "Айди: (%d+)%.",
    ["lfer_NPCInfoentry2"] = "Айди: (%d+)%.",
    ["lfer_NPCInfoentry3"] = "Айди: %1.",
    ["lfer_NPCInfodisplay1"] = "ДисплейID: (%d+)",
    ["lfer_NPCInfodisplay2"] = "ДисплейID: (%d+)",
    ["lfer_NPCInfodisplay3"] = "ДисплейID: %1.",
    ["lfer_NPCInfodisplay21"] = "%(Оригинальный: (%d+)%)",
    ["lfer_NPCInfodisplay22"] = "%(Оригинальный: (%d+)%)",
    ["lfer_NPCInfodisplay23"] = "(Оригинальный: (%1))",
