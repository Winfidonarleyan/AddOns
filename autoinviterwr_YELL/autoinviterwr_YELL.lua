print "|cFFFF0000[Автоинвайт]: |cff6C8CD5Модуль [Крик] загружен"

function autoinviter_YELL(...)
	local msg1, user1 = ...
	msg1 = string.lower(msg1)
	if( magics1[msg1] ) then
		print("|cFFFF0000[Автоинвайт] |cff14ECCF[Крик]: |cff6C8CD5Получено ключевое слово |cffff0000["..msg1.."]")
