print "|cFFFF0000[Автоинвайт]: |cff6C8CD5Модуль [Гильдия] загружен"

function autoinviter_GUILD(...)
	local msg1, user1 = ...
	msg1 = string.lower(msg1)
	if( magics1[msg1] ) then
		print("|cFFFF0000[Автоинвайт] |cff14ECCF[Гильдия]: |cff6C8CD5Получено ключевое слово |cffff0000["..msg1.."]")
